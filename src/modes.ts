...
export const MODE_INFO: Record<GameMode, { name: string; summary: string; detail: string; unit: string }> = {
  ...
  invaders: { name: 'DEFENSIVE POSITION', summary: 'Hold the line.', detail: `Unbroken alien waves. Collect repairs and weapon cores. Extra life every ${INVADER_EXTRA_LIFE_SCORE.toLocaleString('en-GB')} points.`, unit: 'WAVE' },
