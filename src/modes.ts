...
export const MODE_INFO: Record<GameMode, { name: string; summary: string; detail: string; unit: string }> = {
  ...
  invaders: { name: 'INVADERS', summary: 'Hold the line.', detail: 'Alien formations march, swoop and flank. More ships, faster attacks. Supply stop every third wave.', unit: 'WAVE' },
